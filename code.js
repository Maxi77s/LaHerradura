...
$(document).ready(function () {
  $("#formularioCons").submit(function (event) {
      ...
      $.ajax({
          method: 'POST',
          url: 'https://formsubmit.co/ajax/laherraduranievas@gmail.com',
          dataType: 'json',
          accepts: 'application/json',
          data: formData,
          success: function (data) {
              // Manejar la respuesta aquí (puede ser vacía si no necesitas procesar la respuesta)
              console.log(data);
              // Puedes mostrar un mensaje de éxito o realizar otras acciones después de enviar el formulario
              $("#mensaje-exito").fadeIn().delay(3500).fadeOut();
          },
          error: function (err) {
              console.log(err);
